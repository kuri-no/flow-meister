...
export default function ButtonTailwind({ href, text }: ButtonProps) {
  return (
    <Link href={href} className="group inline-flex items-center justify-center gap-5 py-5 px-10 border-2 border-blue-500 rounded-full bg-blue-500 text-base font-extrabold tracking-wider text-white transition-colors duration-300 md:px-20 md:text-xl hover:bg-white hover:text-blue-500">
      {text}
      <svg
      ...
      >
        <path
          className="transition-fill duration-300 group-hover:fill-blue-500"
